namespace ImageConverter
{
    ...
    public class Form1 : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (this.nr.fe[index].Size == 0x230)
            {
        ...
        private void InitializeComponent()
        {
            ...
            this.m_pictureBox.Size = new Size(128, 128);
            ...
            this.Text = "Pokemon Ds/Pic Item Icons";
        ...
        private void MakeImage(FileStream fs)
        {
            ...
            Byte[,,,] numArray = new Byte[4,4,8,4];
            for (int l = 0; l < 0x4; l++)
            {
                for (int i = 0; i < 0x4; i++)
                {
            ...
            //    num += 0x6073;
            //}
            this.m_bitmap = new Bitmap(32, 32, PixelFormat.Format4bppIndexed);
            ...
            Marshal.Copy(source, 0, destination, 0x200);
        ...
        {
            MessageBox.Show("Ds/Pic Item Icons, modified version by SCV\nDs/Pic (C) 2007 loadingNOW", "Info");
        }
