...
namespace HyperGTS
{
    public static class Pokemon
    {
        ...
        private static string DecToBin(long DeciValue, [System.Runtime.InteropServices.OptionalAttribute, System.Runtime.InteropServices.DefaultParameterValueAttribute(8)]  // ERROR: Optional parameters aren't supported in C#
int NoOfBits)
        {
