namespace ImageConverter
{
    ...
    public class Form1 : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (this.nr.fe[index].Size == 0x1930)
            {
                ...
                if (this.menuAutomatch.Checked)
                {
                    for (int i = 0; i < 20; i++)
                    {
                        if (this.nr.fe[index + i].Size == 0x48)
                        {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "Pokemon Ds/Pic Platinum";
        ...
        {
            MessageBox.Show("DS/Pic Platinum, modified version by SCV\n Original DS/Pic (C) 2007 loadingNOW", "Info");
        }
        ...
        private void SaveBin(FileStream fs)
        {
            ...
            uint num2 = 0;/*0x7a53;
            for (int j = 0x0; j<0xc80; j++)
            {
                num2 += numArray[j];
            }*/
            for (int k = 0x0; k <0xc80; k++)
            {
                ushort[] numArray2;
                IntPtr ptr2;
